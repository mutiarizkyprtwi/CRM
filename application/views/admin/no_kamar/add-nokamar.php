                                            ...
                                            <div class="col-xl-12">
                                                ...
                                                action="<?= base_url('no_kamar/add')?>">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" id="lantai" name="lantai" class="form-control" placeholder="" value="<?= set_value('lantai') ?>">
                                                            <?= form_error('lantai', '<label id="lantai-error" class="error text-danger">', '</label>') ?>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
